...
const TableList = () => {
  ...
  const projects = [
    // ===== GLEN DIMPLEX AMERICAS (current role) =====
    {
      id: 50,
      date: "2025-Present",
      title: "Dimplex (dimplex.com)",
      desktopTitle: "Dimplex (dimplex.com)",
      mobileTitle: "Dimplex",
      status: "In Production",
      href: "https://www.dimplex.com",
      linkText: "dimplex.com",
      linkHref: "https://www.dimplex.com",
      tags: ["Drupal", "CommerceTools", "Plytix", "SEO", "GA4"],
    },
    {
      id: 51,
      date: "2025-Present",
      title: "Convectair (convectair.ca)",
      desktopTitle: "Convectair (convectair.ca)",
      mobileTitle: "Convectair",
      status: "In Production",
      href: "https://www.convectair.ca",
      linkText: "convectair.ca",
      linkHref: "https://www.convectair.ca",
      tags: ["Drupal", "Bilingual EN/FR", "CommerceTools", "Plytix"],
    },
    {
      id: 52,
      date: "2025-Present",
      title: "Cadet (cadetheat.com)",
      desktopTitle: "Cadet (cadetheat.com)",
      mobileTitle: "Cadet",
      status: "In Production",
      href: "https://www.cadetheat.com",
      linkText: "cadetheat.com",
      linkHref: "https://www.cadetheat.com",
      tags: ["Drupal", "CommerceTools", "Plytix"],
    },
    {
      id: 53,
      date: "Jan/2026",
      title: "Amazon MAP Violation Monitoring System",
      desktopTitle: "Amazon MAP Violation Monitoring System",
      mobileTitle: "Amazon MAP System",
      status: null,
      href: "#",
      linkText: "Internal tool",
      linkHref: "#",
      tags: ["Fly.io", "GitHub Actions", "Rainforest API", "Python", "Automation"],
    },
    {
      id: 54,
      date: "Mar/2026",
      title: "SEBRA (Second Brain)",
      desktopTitle: "SEBRA (Second Brain)",
      mobileTitle: "SEBRA",
      status: "In Progress",
      href: "https://sebra.vercel.app",
      linkText: "sebra.vercel.app",
      linkHref: "https://sebra.vercel.app",
    ...
    },
    {
      ...
      desktopTitle: "Ember (Botpress Chatbot for Dimplex)",
      mobileTitle: "Ember Chatbot",
      status: "In Development",
      href: "#",
      linkText: "Internal project",
      linkHref: "#",
    ...
    },
    {
      id: 18,
      date: "2024",
      title: "Infanti stores page",
      desktopTitle: "Infanti stores page",
      mobileTitle: "Infanti stores page",
      status: null,
